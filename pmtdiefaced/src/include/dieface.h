...
static const long long validAction[] = {
    NOACTION,      UNDOCUMENTED, FRONTBOW,     BACKBOW,       LEFTBANK,
    RIGHTBANK,     FRONTFLIP,    BACKFLIP,     LEFTROLL,      RIGHTROLL,
    FRONTSEMIFLIP, BACKSEMIFLIP, LEFTSEMIROLL, RIGHTSEMIROLL, FRONT2FLIP,
    BACK2FLIP,     LEFT2ROLL,    RIGHT2ROLL};
