...
compile with
gcc -o ../pmtdiefaced diefacehandler.c diefacemain.c pmtdiefacedaemon.c
-I./include -lrt OR arm-linux-gnueabihf-gcc -o ../pmtdiefaced diefacehandler.c
diefacemain.c pmtdiefacedaemon.c	 -I./include  -lrt
