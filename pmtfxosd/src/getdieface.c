...
int getdieface(struct PMTfxos8700 *fxosnow) {
  ...
  static const int dietable[PITCH][ROLL][YAW] = {
      {{12, 13, 15, 14}, {32, 53, 45, 24}, {42, 23, 35, 54}, {62, 63, 65, 64}},
      {{26, 36, 56, 46}, {36, 56, 46, 26}, {46, 26, 36, 56}, {56, 46, 26, 36}},
      {{51, 41, 21, 31}, {31, 51, 41, 21}, {41, 21, 31, 51}, {21, 31, 51, 41}}};
  ...
  /* roll 0, +90, -90, +-180 <==> 0,1,2,3 */
  if (fxosnow->roll < -135.0 || fxosnow->roll > +135.0)
    roll = 3;
