/**
 * DOC: -- pmtfxosdaemon.c  -- initialize daemon for fxos8700 device --
 * Peter Thompson Jan 2019 - extracted from ~/../daemons2016
 *
 ...
 * arm-linux-gnueabihf-gcc -o pmtfxosd pmtfxosdaemon.c fxos8700stub.c
 * getdieface.c -lrt
 */

/* Function Prototypes */
void pmtfxos8700(void); /* for the big loop process */
 ...
 *
 * daemon started by S60pmtfxosd script
 */
