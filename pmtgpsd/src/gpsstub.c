...
#define DMStoDD(ddmmss)                                                        \
  ((double)(ddmmss / 10000) + ((double)((ddmmss % 10000) / 100)) / 60.0 +      \
   ((double)(ddmmss % 100) / 3600.0))
...
void pmtgps(void) {
  ...
  while (!stopd) {
    ...
    */
    ...
    gpsnow->declination =
        wmmdeclination(-78.36972, 45.21917, 0.440, 2018, 12, 18);
    ...
    gpsnow->declination =
        wmmdeclination(-116.2406, 50.45944, 1.150, 2018, 12, 18);
